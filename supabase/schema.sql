-- Gazdálkodj okosan - Supabase schema
-- FIGYELEM:
-- Ez a séma demonstrációs / hobby használatra van nyitva.
-- Mivel a kliens GitHub Pages-ről fut és nincs külön auth réteg,
-- a policy-k direkt lazák. Éles / publikus használatnál mindenképp szigorítsd.
